...
<body class="page-header-fixed" style="overflow:auto;">
                ...
                <div class="col-md-6" style="width:520px;">
                    <form id="modify_part_form">
                        <table class="common_modal_table" style="width:100%;">
                            <tr>
                                <th style="width:120px;">当前分类层级关系</th>
                            ...
                            <tr>
                                <th>一级分类</th>
                                <td>
                                    <select name="firstCatId" class="" style="width:220px;height:30px;">
                            ...
                            <tr>
                                <th>二级分类</th>
                                <td>
                                    <select name="secondCatId" class="" style="width:220px;height:30px;">
                            ...
                            <tr>
                                <th>三级分类</th>
                                <td>
                                    <select name="thirdCatId" class="" style="width:220px;height:30px;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input name="partCode" maxlength="2" type="text" class="" style="width:220px;height:30px;" onkeyup="modifyPartToChange(this);">
    ...
    <script type="text/template" id="add_cate_init_template">
        ...
        <tr>
            ...
            <td>
                <select id="first_cate_add" class="" style="width:220px;height:30px;" name="firstCatId">
                    <option value="-1">--请选择一级分类--</option>
                </select>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <select id="second_cate_add" class="" style="width:220px;height:30px;" name="secondCatId"><#--name="cateParentId"-->
                    <option value="-1">--请选择二级分类--</option>
                </select>
            </td>
        </tr>
        ...
        <tr>
            <th>位置码<span style="color:red;margin-left:3px;">*</span></th>
            <td>
                <input name="partCode" maxlength="2" type="text" class="" style="width:220px;height:30px;" onkeyup="partCodeChange(this);">
                <span style="margin-left:5px;color:green;">必填，2位数字</span>
            </td>
        </tr>
        <tr>
    ...
    <script type="text/template" id="part_template">
        ...
        <tr>
            <th>二级分类<span style="color:red;margin-left:3px;">*</span></th>
            <td>
                <select id="second_cate_add" class="" style="width:220px;height:30px;" name="secondCatId">
                    <option value="-1">--请选择二级分类--</option>
                </select>
            </td>
        </tr>
    ...
    <script type="text/template" id="third_cate_template">
        ...
        <tr>
            ...
            <td>
                <input name="catCode" maxlength="3" type="text" class="" style="width:220px;height:30px;">
    ...
    <script type="text/template" id="second_cate_template">
        ...
        <tr>
            ...
            <td>
                <input name="catCode" maxlength="2" type="text" class="" style="width:220px;height:30px;">
                <span style="margin-left:5px;color:green;">必填，2位数字</span>
            </td>
        </tr>
    </script>
    ...
    <script type="text/template" id="first_cate_template">
        ...
        <tr>
            ...
            <td>
                <input name="catCode" maxlength="1" type="text" class="" style="width:220px;height:30px;">
                <span style="margin-left:5px;color:green;">必填，2位数字</span>
            </td>
        </tr>
    </script>
    ...
    <script src="/resources/js/category/addCategoryXPart.js" type="text/javascript"></script>
    <script src="/resources/js/category/modifyCategoryXPart.js" type="text/javascript"></script>
